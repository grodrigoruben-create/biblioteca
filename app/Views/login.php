...
placeholder="••••••••" required>
                    ...
                    <div class="text-center">
                        ...
                        <button type="button" class="btn btn-outline-success w-100" data-bs
toggle="modal" data-bs-target="#modalRegistro">
...
<div class="modal fade" id="modalRegistro" tabindex="-1" aria-labelledby="modalRegistroLabel" aria
hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-3">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title fw-bold" id="modalRegistroLabel">Registro de Nuevo Cliente</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria
label="Close"></button>
            </div>
